...
class ProductList extends Component {
    ...
    render() {
        ...
        const {editLabelFlag, searchFlag, quickViewFlag, productId, isCollect, isShowFlag} = this.state;
        let title = dataList.lang === 'cn' ? dataList.title_cn : dataList.title_en,
            ...
            imgPath = dataList._350.location_id === 0 ? dataList.icon_350 : dataList._350.path;
        return (<Fragment>
 ...
 noCollect pointer"/>
                    ...
                    <div className="siteWrap">
                        ...
                        <span className="line"/>
                        <span className="update">{moment(dataList.update_time * 1000).format('YYYY.MM.DD')} 更新</span>
                    </div>
                </div>
                {
                    quickViewFlag &&
