...
import {
    listSortTypeActive, otherScreeningActive
} from "../../../actions/listPageAction";
import {
    globalBreadCrumbActive, globalCat1FlagActive
...
class ProductClassList extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <div id="productListWrapId" ref="container" className="productListWrap searchActive pr"
                    ...
                    {/*提示用户登录*/}
                    {
                        ...
                        <div className="notifyWrap"
                             style={{background: 'url("../../../static/backbod.png") no-repeat center /100%'}}>
